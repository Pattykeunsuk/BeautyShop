...
<body class="bg-gradient-primary">
            ...
            <div class="col-xl-10 col-lg-12 col-md-9">
                ...
                <div class="card o-hidden border-0 shadow-lg my-5">
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            <div class="col-lg-6 d-none d-lg-block bg-login-image" style="background-image: url(<?= base_url(RECURSOS_CONTENIDO.'imagenes/usuario/gato.png');?>);"></div>
                            <div class="col-lg-6">
                                <div class="p-5">
    ...
    <script type="text/javascript" src="<?= base_url(RECURSOS_CONTENIDO.'plugins/js/bootstrap.min.js'); ?>"></script>
    <script type="text/javascript" src="<?= base_url(RECURSOS_CONTENIDO.'plugins/js/bostrap-validator.min.js')?>"></script>

    <!-- ********************************************************** -->
    <!-- **************** BOOTSTRAP NOTIFY********************** -->
    <script src="<?= base_url(RECURSOS_CONTENIDO.'plugins/js/bootstrap-notify.min.js');?>"></script>
