...
<head>
    ...
    <title><?= $nombre_pagina ;?> | Beautyshop</title>
...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
        ...
        <div class="sidebar-brand-text mx-3">Beauty Shop</div>
    </a>
    <!-- MENU LATERAL -->
    <?= $menu; ?>
</ul>
    ...
    <footer class="sticky-footer bg-white">
        <div class="container my-auto">
            <div class="copyright text-center my-auto">
                <span>Copyright &copy; Beauty Shop 2022</span>
            </div>
        </div>
    </footer>
    <!-- End of Footer -->
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <center>
                            <img src="<?= base_url(RECURSOS_CONTENIDO. 'Imagenes/Usuario/boot.png');?>" alt="imagen_usuario" class="img-profile rounded-circle" height="300px"><br>
                            Selecciona "Cerrar" para terminar la sesión.
                        </center>
                    </div>
